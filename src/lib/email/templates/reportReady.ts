export function reportReadyEmail(reportUrl: string): { subject: string; html: string } {
  const subject = "Your planning report is ready";
            ...
            <tr>
              <td style="padding:0 24px 20px 24px;">
                <p style="margin:0;font-size:16px;line-height:1.7;color:#4A5C50;">
                  Click below to open your planning report.
                </p>
              </td>
            </tr>
            <tr>
